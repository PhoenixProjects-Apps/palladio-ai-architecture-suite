        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 space-y-8">
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-semibold text-white mb-2">Welcome to Palladio AI</h2>
                        ...
                        <p className="text-slate-300 leading-relaxed">
                            Our guiding philosophy is simple: <strong className="text-white">Automate. Design. Connect. Build.</strong> We empower industry professionals to focus on what they do best by handling the heavy lifting of spatial analysis, cost estimation, and local compliance through advanced AI.
                        </p>
                    </div>
                </div>
                ...
                {/* Mission Section */}
                <div className="flex items-start gap-4">
                    <Target className="text-violet-400 mt-1" size={24} />
                    <div>
                ...
                {/* What We Do Section */}
                <div className="flex items-start gap-4">
                    <Layers className="text-violet-400 mt-1" size={24} />
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800">
                                <h3 className="font-semibold text-cyan-400 mb-1">Generate Floorplans</h3>
                                <p className="text-sm text-slate-400">Say goodbye to starting from scratch. Our AI generates detailed, perfectly scaled floorplans tailored to any spatial requirement.</p>
                            </div>
                            <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800">
                                <h3 className="font-semibold text-cyan-400 mb-1">3D Renders</h3>
                                <p className="text-sm text-slate-400">Bring your visions to life. We turn basic sketches and 2D concepts into photorealistic, breathtaking architectural visuals instantly.</p>
                            </div>
                            <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800">
                                <h3 className="font-semibold text-cyan-400 mb-1">Assess Plans</h3>
                                <p className="text-sm text-slate-400">Leverage AI-powered assessment for deep, detailed analysis of existing floorplans to maximize utility, flow, and design efficiency.</p>
                            </div>
                            <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800">
                                <h3 className="font-semibold text-cyan-400 mb-1">Town Planner AI</h3>
                                <p className="text-sm text-slate-400">Navigate red tape with ease. Our AI instantly assesses your development plans against local planning schemes, zoning laws, and building codes.</p>
                            </div>
                            <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800">
                                <h3 className="font-semibold text-cyan-400 mb-1">Property Intelligence</h3>
                                <p className="text-sm text-slate-400">Make informed decisions by retrieving crucial zoning information, land details, and rich planning history for any property in seconds.</p>
                            </div>
                            <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800">
                                <h3 className="font-semibold text-cyan-400 mb-1">Cost Estimator</h3>
                                <p className="text-sm text-slate-400">Keep your budget in check with AI-driven material takeoffs and cost estimations powered by live, localized data.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-semibold text-white mb-2">Why Palladio AI?</h2>
                        <p className="text-slate-300 leading-relaxed mb-4">
                        ...
                        <p className="text-slate-300 leading-relaxed font-semibold italic text-violet-300 mb-4">
