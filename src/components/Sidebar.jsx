...
export default function Sidebar() {
      ...
      <div className="flex-1 overflow-y-auto py-2 flex flex-col gap-6" style={{ scrollbarWidth: 'none' }}>
        {menuGroups.map((group, idx) => (
          <div key={idx} className="px-3">
            {!isCollapsed && <div className="px-1 mb-1 text-xs font-semibold text-slate-500 uppercase tracking-wider">{group.title}</div>}
  ...
  return (
    <>
      <div className="md:hidden flex items-right z-50">
        <Button variant="outline" size="icon" onClick={() => setIsMobileOpen(true)} className="bg-[#0a0c10] border-white/10 text-white rounded-xl">
          <Menu size={20} />
        </Button>
      <img src="https://www.image2url.com/r2/default/images/1782439345351-85257dc4-fda3-43f5-9ae4-2f91ee65350a.png" alt="Palladio AI" className="h-9 w-full items-right bg-[#0a0c10] border-white/10 text-white rounded-xl" />
      </div>
